...
=== 요청(Request)
include::{snippets}/mission-controller-test/make-custom-today-mission_success-request/http-request.adoc[]

=== 요청 필드 설명(Request Fields)
include::{snippets}/mission-controller-test/make-custom-today-mission_success-request/request-fields.adoc[]

=== 응답(Response)
include::{snippets}/mission-controller-test/make-custom-today-mission_success-response/http-response.adoc[]

=== 응답 필드 설명(Response Fields)
include::{snippets}/mission-controller-test/make-custom-today-mission_success-response/response-fields.adoc[]
...
=== 요청(Request)
include::{snippets}/mission-controller-test/make-custom-today-mission_-fail_-exceed-limit-request/http-request.adoc[]

=== 요청 필드 설명(Request Fields)
include::{snippets}/mission-controller-test/make-custom-today-mission_-fail_-exceed-limit-request/request-fields.adoc[]

=== 응답(Response)
include::{snippets}/mission-controller-test/make-custom-today-mission_-fail_-exceed-limit-response/http-response.adoc[]

=== 응답 필드 설명(Response Fields)
include::{snippets}/mission-controller-test/make-custom-today-mission_-fail_-exceed-limit-response/response-fields.adoc[]
...
=== 응답(Response)
include::{snippets}/mission-controller-test/accept-recommended-today-mission/http-response.adoc[]
